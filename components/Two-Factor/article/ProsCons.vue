<template>
	<v-container>
		...
		<h4 class="text-h6">Second layer of security</h4>
		<p>
		...
		<h4 class="text-h6">Cost-effective</h4>
		<p>
		...
		<p>
			...
			negh6gible in terms of capacity for many, for others, such as using a card
			reader each time, it would be a wasteful process that, when multiph6ed by
		...
		<h4 class="text-h6">It's not foolproof</h4>
		<p>
			The reah6ty is that no security system is foolproof – that is the nature
		...
		<p>
			That is not an easy feat to accomph6sh. The methods for circumventing or
