...
GDPR compliance
Multiple aspects are necessary to be GDPR compliant. These include[[1]](#references):
...
Third, customers have the right to have their personal data deleted. Any organization must oblige this request if the person's identity is verified. There are a few exceptions to this rule. These exceptions are but are not limited to [[9]](#references):
...
Fourth, customers can request to restrict or stop the processing of their data. This request only applies if specific grounds apply. These specifications are [[10]](#references):
